...
const uint32_t CH_868_225 = 0xD90E67;		//868.225Mhz
const uint32_t CH_868_250 = 0xD91000;		//868.250Mhz
const uint32_t CH_868_275 = 0xD9119A;		//868.275Mhz
const uint32_t CH_868_300 = 0xD91333;		//868.300Mhz
const uint32_t CH_868_325 = 0xD914CD;		//868.325Mhz
const uint32_t CH_868_350 = 0xD91666;		//868.350Mhz
const uint32_t CH_868_375 = 0xD91800;		//868.375Mhz
const uint32_t CH_868_400 = 0xD9199A;		//868.400Mhz
