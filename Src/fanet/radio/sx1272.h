...
// MODES:
#define FSK_MODE_MASK					0xC0
#define SX_IN_FSK_MODE(reg)				(!(reg&FSK_MODE_MASK))
...
//DIO0 MODES
#define DIO0_RX_DONE_LORA				0x00
#define DIO0_TX_DONE_LORA				0x40
#define DIO0_CAD_DONE_LORA				0x10
#define DIO0_NONE_LORA					0xC0
#define DIO0_PACKET_SENT_FSK				0x00
#define DIO0_NONE_FSK					0x80
...
/* FSK extension */
#ifdef SX1272_DO_FSK
	typedef struct sx_fsk_conf_t
	{
		int frep;		//in 0.1Mhz
		int num_syncword;	//1..4
		uint8_t *syncword;
	} sx_fsk_conf_t;
